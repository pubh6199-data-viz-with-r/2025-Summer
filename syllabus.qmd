...
| <i class="bi-building-fill"></i> Milken #423 or [Zoom]({{< var prof-zoom>}}) | <i class="bi-building-fill"></i> Milken 4th floor | <i class="bi-building-fill"></i> [Zoom]({{<var ta-zoom>}}) | <i class="bi-geo-alt-fill"></i> [{{< var room >}}]({{< var room_url >}}) |
...
| Final Project: Data visualization product | 25 % |  |
| Final Project: Presentation | 10 % |  |
| Final Project: Peer evaluation | 5 % |  |
:::
